...
app.get('/api/courses/fetchCourseWork/:courseId', verifyToken, fetchCourseWork)
...
app.post('/api/auth/login', async (req, res) => {
  ...
  return res.status(200).json({redirectUrl : finalRedirectUrl, token : jwtToken, user : newUser});
});
